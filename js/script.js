...
const slider_load = () => {
    setTimeout(() => {
        header.style.backgroundImage = "url('/img/121213.jpg')no-repeat center center/cover";
...
const showClassToggle = (element, className) => {
  if (element) {
...
showClassToggle(document.getElementById('year'), 'show_year1');
showClassToggle(document.getElementById('a_z'), 'show_a_z1');
